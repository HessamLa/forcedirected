class Callback_Base:
    ...
    def on_batch_begin(self, fd_model, epoch, **kwargs):    pass
    def on_batch_end(self, fd_model, epoch, **kwargs):      pass
...
class Model_Base:
    ...
    def notify_epoch_end_callbacks(self, epoch, **kwargs):
        ...
        pass
    def notify_batch_begin_callbacks(self, epoch, **kwargs):
        kwargs['epoch'] = epoch
        for callback in self.callbacks:
            callback.on_batch_begin(self, **kwargs)
        pass
    def notify_batch_end_callbacks(self, epoch, **kwargs):
        kwargs['epoch'] = epoch
        for callback in self.callbacks:
