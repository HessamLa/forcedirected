...
class FDModel(Model_Base):
    ...
    VERSION="0110k100"
    DESCRIPTION="Same as 110. k1=100 for the biased dim, alpha={alpha}"
    def __str__(self):
    ...
    def __init__(self, Gx, n_dim, alpha:float,
        ...
        self.fmodel_repl = ForceClass(name='repulsive_force_hops_exp',
                            ...
                            func=lambda *args, **kwargs: repulsive_force_hops_exp(*args, k1=10, k2=1.0, **kwargs)
                            )
        self.fmodel_repl_biased = ForceClass(name='force_exp_x',
                            func=lambda *args, **kwargs: force_exp_x(*args, k1=100, k2=1.0, **kwargs)
                            )
