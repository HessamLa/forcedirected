...
class FDModel(Model_Base):
    ...
    VERSION="0003"
    DESCRIPTION="Linear repulsive(k1=10, k2=50), alpha={alpha}"
    def __init__(self, Gx, n_dims, alpha:float,
        ...
        self.fmodel_attr = ForceClass(name='attractive_force_ahops', 
                            func=lambda batch: attractive_force_ahops(batch.D, batch.N, batch.unitD, batch.alpha_hops, k1=1, k2=1)
                            )
        self.fmodel_repl = ForceClass(name='repulsive_force_hops',
                            ...
                            func=lambda batch: repulsive_force_hops(batch.D, batch.N, batch.unitD, batch.hops, k1=10, k2=50)
                            )
