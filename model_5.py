...
class FDModel(Model_Base):
    ...
    VERSION="0005"
    DESCRIPTION="Same as Model_4. Regular alpha_hop. Exponential Decay repulsive(k1=10, k2=0.9), alpha={alpha}"
    def __str__(self):
    ...
    def __init__(self, Gx, n_dims, alpha:float,
        ...
        # test 1
        # self.alpha_hops = np.sqrt(1/self.n_nodes)*np.power(self.alpha, self.hops-1)
